<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					...
					i++;
					myInputs[i] = document.getElementById("approver");
					i++;
		...
		var j=0;
					...
					j++;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid approver");
							myInputs[j].focus();
							return false;
						}
					j++;
...
<div id="container">
	<div id="header">
		New Process Instance: /four-eyes-principle/src/main/resources.four-eyes-process
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Process inputs</legend>
                            		...
                            		<div class="div_texbox">
                              		<input name="approver" type="text" class="textbox" id="approver" value="" />
                            		</div>
